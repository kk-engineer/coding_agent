# Coding Agent
A simple implementation of Local Coding Agent using local LLM. 
This project focuses on building autonomous systems capable of summarizing code repo, generating code, suggesting code improvements etc.
